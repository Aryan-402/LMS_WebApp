...
<div class="form-container">
  <h2>Welcome to STABForge Learning Portal</h2>
  <p>Empower Your Learning, Anytime, Anywhere! </p>

  <a href="<%= request.getContextPath() %>/login.jsp" class="button">Sign In</a>
  <a href="<%= request.getContextPath() %>/signup.jsp" class="button">Register Now</a>
